...
<div style="background: #C1C3C8; padding: 1.5rem; border-radius: 8px; border-left: 4px solid #667eea; margin-top: 1rem;">
- **Tipo:** HTTP Bearer
- **Formato:** JWT
...
```json
{
  ...
  "storeName":"KAYSER OPEN ATOCONGO - SAN JUAN DE MIRAFLORES",
  "storeQnty":5
}
