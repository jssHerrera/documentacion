...
| `storeCod` | string | NO | Código de la tienda |
| `storeQnty` | integer | NO | Cantidad de tiendas a mostrar (valor por defecto: 5) |
...
### <span style="color: #667eea;">Mostrar Tiendas</span>

Lista todas las tiendas registradas junto con su código de almacén.

<div style="background: linear-gradient(to right, #667eea, #764ba2); color: white; padding: 0.75rem 1.5rem; border-radius: 6px; display: inline-block; font-weight: 600; margin: 1rem 0;">
  GET /api/v1/bot/tiendas_lista
</div>
...
```json
{
  ...
  "data": {
    "tiendas_encontradas": 3,
    "tiendas": [
      {
        "cod_tienda": "ALM163",
        "nombre_tienda": "TIENDA CHACARILLA",
      },
      {
        "cod_tienda": "ALM162",
        "nombre_tienda": "TIENDA LARCO",
      },
      {
        "cod_tienda": "ALM157",
        "nombre_tienda": "TIENDA LURIN",
